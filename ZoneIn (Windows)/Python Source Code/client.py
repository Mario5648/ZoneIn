...
file = open("C:/ZoneIn/WritableFiles/HostIP.txt",'r')
HOST = file.readline()
file.close()
...
top.iconbitmap('C:/ZoneIn/Icons/jlogoicon.ico')
...
#--send your message--#
photo1 = tkinter.PhotoImage(file = r"C:/ZoneIn/Icons/jbuttonSM.png")
...
photo2 = tkinter.PhotoImage(file = r"C:/ZoneIn/Icons/jbuttonQ.png")
