...
def host():
    ...
    def handle_client(client):
        ...
        file = open('/Applications/ZoneIn/WritableFiles/pd.txt','r')
    ...
    ENDFLAG = [0]
    file = open("/Applications/ZoneIn/WritableFiles/name.txt","r")
...
def startH(totalSeconds,password):
    file = open('/Applications/ZoneIn/WritableFiles/pd.txt','w')
    file.write(str(password)+"\n")
    file.write(str(totalSeconds)+"\n")
    file.close()
    host()

file = open("/Applications/ZoneIn/WritableFiles/GroupSessionSeconds.txt","r")
totalSeconds = file.readline()
file.close()

file = open("/Applications/ZoneIn/WritableFiles/GroupSessionPassword.txt","r")
